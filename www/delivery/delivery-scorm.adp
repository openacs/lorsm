...
<else>
<frameset cols="*,100%" frameborder=0 border=0 framespacing=0 name="page">
</else>
<if @debuglevel@ gt 0>
...
<frame src="blank.html" name="menu" scrolling=no>

<frameset rows="100%,*" border=0 name="DownLeftFrame" noresize border=0 frameborder=0 framespacing=0>
