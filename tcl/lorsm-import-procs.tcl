...
if {![empty_string_p $upload_file]} {
    ns_log Debug "LORS Package: made directory $tmp_dir to extract from $tmpfile ($upload_file)\n"
...
# unzips the file
if { ![empty_string_p $upload_file] && 
     [ catch {set tmp_dir [lors::imscp::expand_file $upload_file $tmpfile lors-imscp-$course_id] } errMsg] } {
