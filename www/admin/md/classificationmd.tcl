...
template::list::create \
    ...
    -actions [list  "[_ lorsm.Add_Classification]" \
                    [export_vars \
                        -base classificationmd/classification_add {ims_md_id}] \
                    "[_ lorsm.lt_Add_another_Classific_2]"] \
    ...
    -elements {
        ...
        export {
            ...
            link_url_eval { [export_vars \
                                -base "classificationmd/classification" \
