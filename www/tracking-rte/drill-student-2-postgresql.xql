...
<fullquery name="organization_item">
  <querytext>
      select o.object_id, repeat('&nbsp;', (tree_level(tree_sortkey) - :indent)* 2) as indent,
      ...
      where
        o.object_type = 'ims_item' and i.org_id = :org_id
        and o.object_id = i.ims_item_id and m.man_id = :man_id
