...
<html>
  ...
  <else>
    ...
    <frame src="applet?man_id=@man_id@&amp;return_url=@return_url@<if @item_id@ defined>&item_id=@item_id@</if><if @ims_id@ defined>&ims_id=@ims_id@</if>&amp;track_id=@track_id@<if @menu_off@ defined>&amp;menu_off=@menu_off@</if>" name="AppletContainerFrame" scrolling=no frameborder="0" title="#lorsm.Applet_frame#">
    <if @menu_off@ lt 1>
      <frameset id="menuvscontent" cols="40%,*" title="#lorsm.Menu_area#">
    </if>
    <else>
