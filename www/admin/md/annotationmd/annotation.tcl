...
template::list::create \
    ...
    -actions [list "[_ lorsm.Add_Entity]" \
                    [export_vars -base annotation_ent {ims_md_an_id ims_md_id}] \
                    "[_ lorsm.Add_another_Entity]"] \
...
template::list::create \
    ...
    -actions [list  "[_ lorsm.Add_Date]" \
                    [export_vars -base annotation_date {ims_md_an_id ims_md_id}] \
                    "[_ lorsm.Add_another_Date]"] \
    -html { align right style "width: 100%;" } \
    -elements {
        date { label "[_ lorsm.Date_1]" }
...
template::list::create \
    ...
    -actions [list  "[_ lorsm.Add_Description]" \
                    [export_vars -base annotation_desc {ims_md_an_id ims_md_id}] \
