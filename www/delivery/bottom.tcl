...
set first_item_url "<a href=\"[export_vars \
                                ...
                                -url {{item_id $first_item_id} man_id}]\"
                                        target=\"content\"><img src=\"../delivery/Images/home.png\"
                                        border=\"0\" title=\"home\"
...
set prev_url "<a href=\"[export_vars \
                            ...
                            -url {{item_id $prev_item_id} man_id}]\"
                                    target=\"content\"><img src=\"Images/prev.png\"
                                    border=\"0\" title=\"next\"
                                    onclick=\"window.location.reload()\"></a>"

set next_url "<a href=\"[export_vars \
                            -base "record-view" \
                            -url {{item_id $next_item_id} man_id}]\"
                                    target=\"content\"><img src=\"Images/next.png\"
                                    border=\"0\" title=\"next\"
                                    onclick=\"window.location.reload()\"></a>"
